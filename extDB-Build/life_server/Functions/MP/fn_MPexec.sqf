...
_validFunctions = ["bis_fnc_execvm","bis_fnc_effectkilledairdestruction","bis_fnc_effectkilledairdestructionstage2","bis_fnc_spawn","ghb_fnc_handlemessages","ghb_fnc_cleanupmessages","ghb_fnc_msgrequest"]; //Only these functions can be passed via BIS_fnc_MP
