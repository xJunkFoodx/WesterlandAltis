...
switch(_type) do
{
    ...
    case "34": {_type = ["Personenschaden - Unfall",50000];};
	case "35": {_type = ["Personenschaden - Vorsatz",100000];};
    case "36": {_type = ["Fliegen über Siedlung unter 150m",10000];};
    case "37": {_type = ["Landen innerhalb 500m zur Siedlung",10000];};
    case "38": {_type = ["Landen auf Straßen",15000];};
    case "39": {_type = ["Landen in gesperrten Gebieten",30000];};
    case "40": {_type = ["Heli-Flucht Unterstützung",20000];};
    case "41": {_type = ["Fliegen ohne Kollisionsleuchten",5000];};
	case "42": {_type = ["Fliegen ohne Lizens",10000];};
	case "43": {_type = ["Kein Sanikasten als Fahrzeugführer",250];};
	case "44": {_type = ["Kein Werkzeugkasten als Fahrzeugführer",250];};
	case "45": {_type = ["Innerorts über 50km/h",750];};
	case "46": {_type = ["Innerorts über 60km/h",1500];};
	case "47": {_type = ["Innerorts über 85km/h",5000];};
	case "48": {_type = ["Innerorts über 110km/h",20000];};
	case "49": {_type = ["Innerorts über 200km/h",50000];};
	case "50": {_type = ["Außerorts über 130km/h",5000];};
	case "51": {_type = ["Außerorts über 180km/h",10000];};
	case "52": {_type = ["Außerorts über 230km/h+",20000];};
	case "53": {_type = ["Fahren ohne Fahrerlaubnis",5000];};
	case "54": {_type = ["Fahren ohne Licht [Nachts]",2000];};
	case "55": {_type = ["Fahren auf der falschen Straßenseite",3000];};
	case "56": {_type = ["Unfallverursacher",5000];};
	case "57": {_type = ["Fahrerflucht nach Unfall",5000];};
	case "58": {_type = ["Behinderung des Verkehrs",1000];};
	case "59": {_type = ["Vorsätzliches Überfahren von Spielern",0];};
	case "60": {_type = ["Falschparken",1000];};
	case "61": {_type = ["Behinderung des Fahrzeugspawns",2000];};
	case "62": {_type = ["Offroad (übers Feld fahren)",5000];};
	case "63": {_type = ["Fahren in gesperrten Gebieten",30000];};
	case "64": {_type = ["Verbotene Fahrzeuge",100000];};
